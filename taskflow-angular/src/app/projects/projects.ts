...
import { ProjectStateService } from '../services/project-state';
...
export class Projects implements OnInit, OnDestroy {
  ...
  readonly isLoading = this.projectState.isLoading;
  readonly errorMessage = this.projectState.errorMessage;
  ...
  submit(): void {
    ...
    const request = editing
      ? this.projectState.update(editing._id, {
  ...
  deleteProject(project: Project): void {
    if (this.deletingProjectId() || project.taskCount > 0) {
      return;
    }
    ...
    this.projectState.clearError();
    this.deletingProjectId.set(project._id);
